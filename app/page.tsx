    ...
    <div className="relative min-h-screen space-bg text-zinc-100 overflow-y-auto">
      <header className="flex fixed  w-full justify-center items-center pt-6">
        <nav className="flex items-center gap-6 rounded-full border border-white/10 max-w-6xl bg-zinc-900/70 px-4 py-2 backdrop-blur mx-auto">
          ...
          <div className="ml-2 flex items-center gap-2">
            <Link href="signup" className="hidden sm:inline-flex rounded-full bg-indigo-600 px-4 py-2 text-sm font-semibold text-white hover:bg-indigo-500">Get started free</Link>
            <Link href="/login" className="inline-flex rounded-full bg-black px-4 py-2 text-sm font-semibold text-white ring-1 ring-white/10 hover:ring-white/20">Sign in</Link>
          </div>
        </nav>
      </header>
      ...
      <main className="mx-auto max-w-5xl px-6 pt-48 pb-20 text-center">
        ...
        <div className="mt-8 flex flex-col items-center gap-4">
          <div className="rounded-full bg-white/5 px-4 py-2 text-sm ring-1 ring-white/10">eventlaunch.com / reactsummit@2025</div>
          <Link href="/signup" className="inline-flex items-center justify-center rounded-full bg-blue-600 px-6 py-3 text-sm font-semibold text-white shadow hover:bg-blue-500">Get started free</Link>
        </div>
